...
class OrderBase(SQLModel):
    user_id: int = Field(foreign_key="users.id", nullable=False, index=True, description="Purchaser user identifier")
...
class OrderItemBase(SQLModel):
    order_id: int = Field(foreign_key="orders.id", nullable=False, index=True, description="Parent order identifier")
    product_id: int = Field(foreign_key="products.id", nullable=False, description="Purchased product identifier")
